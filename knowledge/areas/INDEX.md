...
- [relay-feeds-zigbee-bulbs](relay-feeds-zigbee-bulbs.md) — A relay powering smart bulbs must never be cut to turn lights off — it kills the bulbs' radio.
  - **before**: About to edit ensuite bathroom lighting automations; About to turn off a light group whose members are mains-fed via a relay
  - **symptom**: Zigbee bulbs go unavailable when lights turn off; light group stuck reporting on while bulbs are off
