...
- **Every light-ON path must ensure the relay is on first**, then settle ~1s (bulbs rejoin Zigbee), *then* command bulbs. Lets lighting recover smoothly from a cold relay after a restart.
